...
//   const [modelSize, setModelSize] = useState([1, 1, 1]);
//   const [modelPosition, setModelPosition] = useState([0, 0, 0]); // Track model position
...
//     // console.log(position);
//     setModelSize([size.x, size.y, size.z]);
//     setModelPosition([position.x, position.y, position.z]); // Update model position
//   };
...
//     // This finds and clicks the hidden button in the ScreenshotButton component
...
// Import model-viewer for AR capabilities
